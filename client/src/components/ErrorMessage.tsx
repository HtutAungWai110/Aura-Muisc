    ...
    <AnimatePresence>
      {errorMessage && (
        <motion.div
          ...
          className="fixed top-10 right-10 z-900 min-w-100 max-w-80 bg-surface-container-highest text-on-surface border border-white/10 shadow-2xl rounded-lg"
        >
          <Alert className="border-none bg-transparent">
            <InfoIcon className="text-error" />
            <AlertTitle className="text-on-surface font-bold">Error!</AlertTitle>
